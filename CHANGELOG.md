...
--------------------------
**Library - Chore**
- [PR #101](https://github.com/sendgrid/csharp-http-client/pull/101): update GitHub branch references to use HEAD. Thanks to [@thinkingserious](https://github.com/thinkingserious)!
...
--------------------------
**Library - Chore**
- [PR #99](https://github.com/sendgrid/csharp-http-client/pull/99): remove unused function. Thanks to [@thinkingserious](https://github.com/thinkingserious)!
...
--------------------------
**Library - Fix**
- [PR #97](https://github.com/sendgrid/csharp-http-client/pull/97): update deploy path for .nupkg. Thanks to [@thinkingserious](https://github.com/thinkingserious)!
